...
{
    [Theory]
    [InlineData("10.20.30.2", 24, "10.20.30.1", true)]
    [InlineData("10.20.30.254", 24, "10.20.30.1", true)]
    [InlineData("10.20.30.1", 24, "10.20.30.1", true)]
    [InlineData("192.168.1.2", 24, "10.20.30.1", true)]
    [InlineData("172.20.4.10", 24, "172.20.4.1", true)]
    [InlineData("8.8.8.8", 24, "10.20.30.1", false)]
    [InlineData("10.20.30.2", 16, "10.20.30.1", false)]
    [InlineData("10.20.30.255", 24, "10.20.30.1", false)]
    ...
    public void Defaults_match_the_approved_design()
    {
        ...
        Assert.Equal("10.20.30.2", options.BindIp);
        Assert.Equal(24, options.PrefixLength);
        Assert.Equal("10.20.30.1", options.RouterIp);
